...
See also: biomcp list trial")]
    ...
    #[command(after_help = "\
EXAMPLES:
  biomcp search organization \"MD Anderson\"
  biomcp search organization -q \"Dana-Farber\" --city Boston --state MA

See also: biomcp list organization")]
    Organization {
        /// Free text organization query (maps to NCI `name`)
        #[arg(short, long)]
        query: Option<String>,
        /// Optional positional query alias for -q/--query
        #[arg(value_name = "QUERY")]
        ...
        /// Organization type (e.g., academic, industry)
        #[arg(long = "type")]
        ...
        /// Organization state/province filter
        #[arg(long)]
        state: Option<String>,
...
EXAMPLES:
  ...
  biomcp search intervention -q nivolumab --type drug --category agent

See also: biomcp list intervention")]
    Intervention {
        /// Free text intervention query (maps to NCI `name`)
        #[arg(short, long)]
        query: Option<String>,
        /// Optional positional query alias for -q/--query
        #[arg(value_name = "QUERY")]
        ...
        /// Intervention type (e.g., drug, device, procedure)
        #[arg(long = "type")]
        ...
        /// Intervention code (or comma-separated codes)
        #[arg(long)]
        code: Option<String>,
    ...
    #[command(after_help = "\
EXAMPLES:
  biomcp search biomarker \"PD-L1\"
  biomcp search biomarker -q HER2 --type reference_gene --assay-purpose eligibility

See also: biomcp list biomarker")]
    Biomarker {
        /// Free text biomarker query (maps to NCI `name`)
        #[arg(short, long)]
        query: Option<String>,
        /// Optional positional query alias for -q/--query
        #[arg(value_name = "QUERY")]
        ...
        /// Biomarker type
        #[arg(long = "type")]
        biomarker_type: Option<String>,

        /// Eligibility criterion text filter
        #[arg(long = "eligibility")]
        eligibility_criterion: Option<String>,

        /// Assay purpose filter
        #[arg(long = "assay-purpose")]
        assay_purpose: Option<String>,

        /// Biomarker code (or comma-separated codes)
        #[arg(long)]
        code: Option<String>,
            ...
            Commands::Search { entity } => {
                ...
                SearchEntity::Organization {
                    ...
                    if cli.json {
                        ...
                        let footer = pagination_footer_offset(&pagination);
                        Ok(crate::render::markdown::organization_search_markdown_with_footer(
                            &query_summary,
                            &results,
                            &footer,
                        )?)
                ...
                SearchEntity::Intervention {
                    ...
                    if cli.json {
                        ...
                        let footer = pagination_footer_offset(&pagination);
                        Ok(crate::render::markdown::intervention_search_markdown_with_footer(
                            &query_summary,
                            &results,
                            &footer,
                        )?)
                ...
                SearchEntity::Biomarker {
                    ...
                    if cli.json {
                        ...
                        let footer = pagination_footer_offset(&pagination);
                        Ok(crate::render::markdown::biomarker_search_markdown_with_footer(
                            &query_summary,
                            &results,
                            &footer,
                        )?)
