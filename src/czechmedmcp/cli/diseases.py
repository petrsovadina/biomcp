...
def get_disease_cli(
    ...
    Examples:
        ...
        czechmedmcp disease get "lung cancer"
        czechmedmcp disease get GIST
    """
...
def search_diseases_cli(
    ...
    Examples:
        ...
        czechmedmcp disease search melanoma

        # Search NCI cancer terms
        czechmedmcp disease search melanoma --source nci

        # Search without synonyms
        czechmedmcp disease search "breast cancer" --no-synonyms --source nci

        # Filter by category
        czechmedmcp disease search --category neoplasm --source nci
    """
    if source == "nci":
        # Use NCI CTS API
        try:
