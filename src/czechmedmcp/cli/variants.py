...
def get_variant(
    ...
    Examples:
        Get by HGVS: czechmedmcp variant get "chr7:g.140453136A>T"
        Get by rsID: czechmedmcp variant get rs113488022
        Get as JSON: czechmedmcp variant get rs113488022 --json
        Get without external annotations: czechmedmcp variant get rs113488022 --no-external
        Get with hg38 assembly: czechmedmcp variant get rs113488022 --assembly hg38
        Get full details: czechmedmcp variant get rs113488022 --extensive
    """
    if not variant_id:
...
def predict_variant_effects(
    ...
    \n\tczechmedmcp variant predict chr7 140753336 A T
    \n
    \n\t# With API key specified
    \n\tczechmedmcp variant predict chr7 140753336 A T --api-key YOUR_KEY
    \n
    \n\t# With tissue-specific predictions
    \n\tczechmedmcp variant predict chr7 140753336 A T --tissue UBERON:0002367
    \n
    \n\t# With larger analysis interval
    \n\tczechmedmcp variant predict chr7 140753336 A T --interval 500000
    """
