...
from czechmedmcp.core import ensure_list, mcp_app
...
# Article Tools
@mcp_app.tool()
@track_performance("czechmedmcp.article_searcher")
...
@mcp_app.tool()
@track_performance("czechmedmcp.article_getter")
...
# Trial Tools
@mcp_app.tool()
@track_performance("czechmedmcp.trial_searcher")
...
@mcp_app.tool()
@track_performance("czechmedmcp.trial_getter")
...
@mcp_app.tool()
@track_performance("czechmedmcp.trial_protocol_getter")
...
@mcp_app.tool()
@track_performance("czechmedmcp.trial_references_getter")
...
@mcp_app.tool()
@track_performance("czechmedmcp.trial_outcomes_getter")
...
@mcp_app.tool()
@track_performance("czechmedmcp.trial_locations_getter")
...
# Variant Tools
@mcp_app.tool()
@track_performance("czechmedmcp.variant_searcher")
...
@mcp_app.tool()
@track_performance("czechmedmcp.variant_getter")
...
@mcp_app.tool()
@track_performance("czechmedmcp.alphagenome_predictor")
...
# Gene Tools
@mcp_app.tool()
@track_performance("czechmedmcp.gene_getter")
...
@mcp_app.tool()
@track_performance("czechmedmcp.enrichr_analyzer")
...
# Disease Tools
@mcp_app.tool()
@track_performance("czechmedmcp.disease_getter")
...
@mcp_app.tool()
@track_performance("czechmedmcp.drug_getter")
...
# NCI-Specific Tools
@mcp_app.tool()
@track_performance("czechmedmcp.nci_organization_searcher")
async def nci_organization_searcher(
    ...
    from czechmedmcp.organizations.search import format_organization_results
...
@mcp_app.tool()
@track_performance("czechmedmcp.nci_organization_getter")
async def nci_organization_getter(
    ...
    from czechmedmcp.organizations.getter import format_organization_details
...
@mcp_app.tool()
@track_performance("czechmedmcp.nci_intervention_searcher")
async def nci_intervention_searcher(
    ...
    from czechmedmcp.interventions.search import format_intervention_results
...
@mcp_app.tool()
@track_performance("czechmedmcp.nci_intervention_getter")
async def nci_intervention_getter(
    ...
    from czechmedmcp.interventions.getter import format_intervention_details
...
# Biomarker Tools
@mcp_app.tool()
@track_performance("czechmedmcp.nci_biomarker_searcher")
async def nci_biomarker_searcher(
    ...
    from czechmedmcp.biomarkers.search import format_biomarker_results
    from czechmedmcp.integrations.cts_api import CTSAPIError
...
# NCI Disease Tools
@mcp_app.tool()
@track_performance("czechmedmcp.nci_disease_searcher")
...
# OpenFDA Tools
@mcp_app.tool()
@track_performance("czechmedmcp.openfda_adverse_searcher")
...
@mcp_app.tool()
@track_performance("czechmedmcp.openfda_adverse_getter")
...
@mcp_app.tool()
@track_performance("czechmedmcp.openfda_label_searcher")
...
@mcp_app.tool()
@track_performance("czechmedmcp.openfda_label_getter")
...
@mcp_app.tool()
@track_performance("czechmedmcp.openfda_device_searcher")
...
@mcp_app.tool()
@track_performance("czechmedmcp.openfda_device_getter")
...
@mcp_app.tool()
@track_performance("czechmedmcp.openfda_approval_searcher")
...
@mcp_app.tool()
@track_performance("czechmedmcp.openfda_approval_getter")
...
@mcp_app.tool()
@track_performance("czechmedmcp.openfda_recall_searcher")
...
@mcp_app.tool()
@track_performance("czechmedmcp.openfda_recall_getter")
...
@mcp_app.tool()
@track_performance("czechmedmcp.openfda_shortage_searcher")
...
@mcp_app.tool()
@track_performance("czechmedmcp.openfda_shortage_getter")
