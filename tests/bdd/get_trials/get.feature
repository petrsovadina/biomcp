Feature: Get Clinical Trial Details for NCT04280705
  ...
  Scenario: PROTOCOL module details
    Given I run "czechmedmcp trial get NCT04280705 Protocol --json"
  ...
  Scenario: LOCATIONS module details
    Given I run "czechmedmcp trial get NCT04280705 Locations --json"
  ...
  Scenario: REFERENCES module details
    Given I run "czechmedmcp trial get NCT04280705 References --json"
  ...
  Scenario: OUTCOMES module details
    Given I run "czechmedmcp trial get NCT04280705 Outcomes --json"
