...
---
# ctx
Nearby nodes to: /Users/petrsovadina/Desktop/Develope/personal/CzechMed-MCP/voicetree-28-3/climodule.md
```
CLI & Server Modes
└── Voicetree
...
<TASK> IMPORTANT. YOUR specific task, and the most relevant context is the source note you were spawned from, which is:
        /Users/petrsovadina/Desktop/Develope/personal/CzechMed-MCP/voicetree-28-3/climodule.md: # CLI & Server Modes
